...
const AddToList: React.FC<IProps> = ({people, setPeople}) => {
    ...
    return (
        <div className="AddToList">
            ...
            <input type="text" className="AddToList-input" placeholder="Age" value={input.age} onChange={handleChange} name="age"/>
            <input type="text" className="AddToList-input" placeholder="Image Url" value={input.img} onChange={handleChange} name="img"/>
            <textarea className="AddToList-input" placeholder="Notes" value={input.note} onChange={handleChange} name="note"/>
